...
namespace Play.Inventory.Service.Controllers
{
    ...
    public class ItemsController : ControllerBase
    {
        ...
        {
            var InventoryItem = await itemsRepository.GetAsynq(item => item.UserId == grantItemsDto.UserId && item.CatalogItemId == grantItemsDto.CatalogItemId);
            ...
            if (InventoryItem == null)
            {
                InventoryItem = new InventoryItem
                {
                    ...
                    Quantity = grantItemsDto.Quantiy,
            ...
            {
                InventoryItem.Quantity += grantItemsDto.Quantiy;
